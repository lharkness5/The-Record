...
interface FederalScreenProps {
  navigation: NativeStackNavigationProp<any>;
}

export const FederalScreen: React.FC<FederalScreenProps> = ({ navigation }) => {
  const [searchQuery, setSearchQuery] = useState('');
  const [selectedTopic, setSelectedTopic] = useState<Topic | null>(null);
  const [selectedStatus, setSelectedStatus] = useState<BillStatus | null>(null);

  // Filter for federal changes (in a real app, you'd have federal-specific data)
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      <View style={styles.header}>
        <Text style={styles.title}>Federal</Text>
        <Text style={styles.subtitle}>National Legislation & Policy Changes</Text>
      </View>

      <View style={styles.searchContainer}>
        <TextInput
          style={styles.searchInput}
          placeholder="Search federal bills and changes..."
      ...
      >
        ...
        <View style={styles.infoCard}>
          <Text style={styles.infoTitle}>About Federal Changes</Text>
          <Text style={styles.infoText}>
            We track legislation, executive orders, court rulings, and regulatory
            changes from Congress, the White House, and federal agencies. Each item
            is selected for its national impact and summarized in plain language.
          </Text>
          <Text style={styles.infoText}>
            Updates are published as significant changes occur at the federal level.
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
